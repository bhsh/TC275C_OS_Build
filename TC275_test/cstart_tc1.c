...
**      and the application C variables for core 1.       *
**                                                                        *
**  Copyright 1996-2014 Altium BV                                         *
**                                                                        *
**************************************************************************/

#include "cstart_tc1.h"         /* include configuration */
...
#if ( 1==1 || 1==2 ) && ( defined _REGTC23X_ADAS_H || defined _REGTC23X_H )
#pragma message "The tc23x only supports core 0"
#else
#if 1==2 && ( defined _REGTC26X_H )
...
#if __USE_ARGC_ARGV_TC1
static char argcv_tc1[__ARGCV_BUFSIZE_TC1];
extern int _argcv( const char *, size_t );
#endif

/* linker definitions */
extern __far void _lc_ue_ustack_tc1[];  /* user stack end */
extern __far void _lc_ue_istack_tc1[];  /* interrupt stack end */
extern __far void _lc_u_int_tab_tc1[];  /* interrupt table */
extern __far void _lc_u_trap_tab_tc1[]; /* trap table */
extern __far void _SMALL_DATA_TC1[];       /* centre of A0 addressable area */
extern __far void _LITERAL_DATA_TC1[];     /* centre of A1 addressable area */
extern __far void _A8_DATA_TC1[];          /* centre of A8 addressable area */
extern __far void _A9_DATA_TC1[];          /* centre of A9 addressable area */

/* external functions */
#if __C_TC1_INIT
extern void _c_init_tc1(void);          /* C initialization function */
#endif
#ifdef __CALL_TC1_INIT
extern void _call_init_tc1(void);               /* call a user function before main() */
#endif
#ifdef __CALL_ENDINIT_TC1
extern void _endinit_tc1(void);         /* call a user function with protection switched off */
#endif
...
extern void _endinit_clear_tc1(void) { endinit_set(_ENDINIT_DISABLE); }
extern void _endinit_set_tc1  (void) { endinit_set(_ENDINIT_ENABLE); }

#if __C_TC1_INIT || _CALL_ENDINIT_TC1 || (defined __CALL_TC1_INIT)
/* c init semaphores */
extern unsigned int volatile __far      _tcx_end_c_init;        /* _tcx_end_c_init := 1 << core_id */
#pragma   weak  _tcx_end_c_init
#endif

void __noreturn__ __jump__ _start_tc1( void )
{
        __init_sp();
}
...
#if  __USP_TC1_INIT
        unsigned int sp = (unsigned int)(_lc_ue_ustack_tc1) & STACK_ALIGN;
...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
        ...
        /*
         * Clear the ENDINIT bit in the SCU_WDTCPU1CON0 register in order
         ...
         */
#if __BTV_TC1_INIT
        __mtcr(BTV,  (unsigned int)_lc_u_trap_tab_tc1);
#endif
         ...
         */
#if __BIV_TC1_INIT
#if __BIV_SINGLE_TC1_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC26X_H  || defined _REGTC29X_H)
        /*
         * Single Entry Vector Table, for core tc1.6.x, is supported
         * by _sevt_isr_tc1() calling interrupt handlers installed
         * with _sevt_isr_install() stored in _sevt_isrs_tc1 list.
         * The _sevt_isr_tc1() is located at interrupt vector table
         * entry 64. The start address of the interrupt vector table
         * is defined by linker definition INTTAB1.
         */
#pragma extern _sevt_isr_tc1
        __mtcr(BIV, (unsigned int)(_lc_u_int_tab_tc1) | (0xff<<3) | 1 );
#else
#if __BIV_8BYTE_TC1_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC27XC_H || defined _REGTC26X_H || defined _REGTC29X_H)
        __mtcr(BIV, (unsigned int)(_lc_u_int_tab_tc1) | 1 );    /* 8 Byte vector spacing */
#else
        __mtcr(BIV, (unsigned int)(_lc_u_int_tab_tc1));         /* 32 Byte vector spacing */
#endif
#endif
#endif
         ...
         */
#if __ISP_TC1_INIT
        unsigned int isp = (unsigned int)(_lc_ue_istack_tc1) & STACK_ALIGN;
        __mtcr(ISP, isp);
#endif
        ...
        /*
         * Set the ENDINIT bit in the SCU_WDTCPU1CON0 register again
         ...
         */
#if __A0A1_TC1_INIT
        void * a0 = _SMALL_DATA_TC1;
        __asm( "mov.aa\ta0,%0"::"a"(a0) );

        void * a1 = _LITERAL_DATA_TC1;
         ...
         */
#if __A8A9_TC1_INIT
        void * a8 = _A8_DATA_TC1;
        __asm( "mov.aa\ta8,%0"::"a"(a8) );

        void * a9 = _A9_DATA_TC1;
...
#  define MAX_NR_OF_CSA_AREAS     1
        extern int _lc_ub_csa_tc1[][16];    /* context save area 1 begin */
        extern int _lc_ue_csa_tc1[][16];    /* context save area 1 end   */
        static __far int (* const csa_area_begin[])[16] = { _lc_ub_csa_tc1}; 
        static __far int (* const csa_area_end[])[16]   = { _lc_ue_csa_tc1};
        ...
        if ( &_tcx_end_c_init )
        {
                __swapmskw( (unsigned int *)&_tcx_end_c_init, 1<<1, 1<<1 );     /* tc1 end of initialization */
                /*
...
#define __COREN_HALT__          ( ( (CPU1_DBGSR.B.HALT & 0x1)==0 ) << 1 )
#endif
                while ( ( _tcx_end_c_init & 0x7 ) != (1<<1 | ( ( (CPU0_DBGSR.B.HALT & 0x1)==0 ) << 0) | __COREN_HALT__) ) ;
        }
#endif
         ...
         */
#if __USE_ARGC_ARGV_TC1
        exit( main( _argcv( argcv_tc1, __ARGCV_BUFSIZE_TC1), (char **)argcv_tc1) );
#else
         ...
         */
#if __BTV_TC1_INIT
#  if __RESOLVE_TRAP_0_TC1
#    pragma extern  _trapmmu
#  endif
#  if __RESOLVE_TRAP_1_TC1
#    pragma extern  _trapprotection
#  endif
#  if __RESOLVE_TRAP_2_TC1
#    pragma extern  _trapinstruction
#  endif
#  if __RESOLVE_TRAP_3_TC1
#    pragma extern  _trapcontext
#  endif
#  if __RESOLVE_TRAP_4_TC1
#    pragma extern  _trapbus
#  endif
#  if __RESOLVE_TRAP_5_TC1
#    pragma extern  _trapassertion
#  endif
#  if __RESOLVE_TRAP_6_TC1
#    pragma extern  _trapsystem
#  endif
#  if __RESOLVE_TRAP_7_TC1
 ...
 *
 * DESCRIPTION:  Sets or Clears the ENDINIT bit in the SCU_WDTCPU1CON0
...
static void inline endinit_set( _endinit_t endinit_value )
{
        ...
        /*
         * 1st step: Password access (create password and send to SCU_WDTCPU1CON0)
         */        
        wdt_con0 = SCU_WDTCPU1CON0.U;
        ...
        SCU_WDTCPU1CON0.U = wdt_con0;

        /*
         * 2nd step: Modify access, set the bit ENDINIT to 1 or 0 to allow access to
         *           registers: SCU_WDTCPU1CON1, BTV, BIV, ISP and mod_CLC
         *
         */
        ...
        __isync();
        SCU_WDTCPU1CON0.U = wdt_con0;          
        SCU_WDTCPU1CON0.U;         /* read is required */
}
#endif
#endif
