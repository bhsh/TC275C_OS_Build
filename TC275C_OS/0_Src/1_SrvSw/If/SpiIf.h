...
typedef struct
{
    ...
    uint32 csLeadDelay : 3;             /**< \brief \ref SpiIf_SlsoTiming */
    uint32 csTrailDelay : 3;            /**< \brief \ref SpiIf_SlsoTiming */
    uint32 csInactiveDelay : 3;         /**< \brief \ref SpiIf_SlsoTiming */
...
{
    SpiIf          *driver;         /**< \brief Pointer to an implementation of SPI interface driver, e.g. \ref IfxQspi_Spi */
