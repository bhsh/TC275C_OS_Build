...
{
    Ifx_GTM_TOM_CH *tomCh = (Ifx_GTM_TOM_CH *)((uint32)&tom->CH0.CTRL.U + 0x40 * channel);
...
{
    Ifx_GTM_TOM_CH *tomCh = (Ifx_GTM_TOM_CH *)((uint32)&tom->CH0.CTRL.U + 0x40 * channel);
    return (volatile uint32 *)&tomCh->CM1;
}
...
{
    Ifx_GTM_TOM_CH *tomCh = (Ifx_GTM_TOM_CH *)((uint32)&tom->CH0.CTRL.U + 0x40 * channel);
    return (volatile uint32 *)&tomCh->CM0;
}
...
{
    Ifx_GTM_TOM_CH *tomCh = (Ifx_GTM_TOM_CH *)((uint32)&tom->CH0.CTRL.U + 0x40 * channel);
    return (volatile uint32 *)&tomCh->CN0;
}
