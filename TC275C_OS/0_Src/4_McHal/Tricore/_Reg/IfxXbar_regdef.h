...
typedef struct _Ifx_XBAR_ARBITER2_DBADD_Bits
{
    ...
    unsigned int ADDRESS2:1;                /**< \brief [27:27] Debug Address Boundary (rw) */
    unsigned int ONE0:1;                    /**< \brief [28:28] Reserved (r) */
    unsigned int ADDRESS3:1;                /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int ONE1:1;                    /**< \brief [30:30] Reserved (r) */
    unsigned int ADDRESS4:1;                /**< \brief [31:31] Debug Address Boundary (rw) */
...
typedef struct _Ifx_XBAR_ARBITER2_DBMADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS0:19;               /**< \brief [20:2] Debug Address Boundary (rw) */
    unsigned int ONE0:2;                    /**< \brief [22:21] Reserved (r) */
    unsigned int ADDRESS1:1;                /**< \brief [23:23] Debug Address Boundary (rw) */
    unsigned int ONE1:3;                    /**< \brief [26:24] Reserved (r) */
    unsigned int ADDRESS2:1;                /**< \brief [27:27] Debug Address Boundary (rw) */
    unsigned int ONE2:1;                    /**< \brief [28:28] Reserved (r) */
    unsigned int ADDRESS3:1;                /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int ONE3:1;                    /**< \brief [30:30] Reserved (r) */
    unsigned int ADDRESS4:1;                /**< \brief [31:31] Debug Address Boundary (rw) */
...
typedef struct _Ifx_XBAR_ARBITER6_DBADD_Bits
{
    ...
    unsigned int ONE0:1;                    /**< \brief [27:27] Reserved (r) */
    unsigned int ADDRESS1:3;                /**< \brief [30:28] Debug Address Boundary (rw) */
    unsigned int ONE1:1;                    /**< \brief [31:31] Reserved (r) */
...
typedef struct _Ifx_XBAR_ARBITER7_DBMADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS0:19;               /**< \brief [20:2] Debug Address Boundary (rw) */
    unsigned int ONE0:8;                    /**< \brief [28:21] Reserved (r) */
    unsigned int ADDRESS1:1;                /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int ONE1:2;                    /**< \brief [31:30] Reserved (r) */
...
typedef struct _Ifx_XBAR_ARBITER8_DBADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS0:19;               /**< \brief [20:2] Debug Address Boundary (rw) */
    unsigned int ONE0:1;                    /**< \brief [21:21] Reserved (r) */
...
typedef struct _Ifx_XBAR_IDINTEN_Bits
{
    ...
    unsigned int ENSCI2:1;                  /**< \brief [2:2] Enable ID Error from SCI2 (rw) */
    unsigned int reserved_3:1;              /**< \brief \internal Reserved */
    ...
    unsigned int ENMCI6:1;                  /**< \brief [22:22] Enable ID Error from MCI6 (rw) */
    ...
    unsigned int ENMCI10:1;                 /**< \brief [26:26] Enable ID Error from MCI10 (rw) */
    unsigned int ENMCI11:1;                 /**< \brief [27:27] Enable ID Error from MCI11 (rw) */
...
{
    unsigned int IDCSCI0:1;                 /**< \brief [0:0] Transaction ID Error from SCI0 Status (rwh) */
    unsigned int IDCSCI1:1;                 /**< \brief [1:1] Transaction ID Error from SCI1 Status (rwh) */
    unsigned int IDCSCI2:1;                 /**< \brief [2:2] Transaction ID Error from SCI2 Status (rwh) */
    unsigned int reserved_3:1;              /**< \brief \internal Reserved */
    ...
    unsigned int IDMCI6:1;                  /**< \brief [22:22] Transaction ID Error from MCI6 Status (rwh) */
    unsigned int reserved_23:1;             /**< \brief \internal Reserved */
    ...
    unsigned int IDMCI10:1;                 /**< \brief [26:26] Transaction ID Error from MCI10 Status (rwh) */
    unsigned int IDMCI11:1;                 /**< \brief [27:27] Transaction ID Error from MCI11 Status (rwh) */
...
typedef struct _Ifx_XBAR_INTSAT_Bits
{
    ...
    unsigned int SCSCI2:1;                  /**< \brief [2:2] Starvation Error from SCI2 Status (rwh) */
    unsigned int reserved_3:1;              /**< \brief \internal Reserved */
    ...
    unsigned int PRSCI2:1;                  /**< \brief [18:18] Protocol Error from SCI2 Status (rwh) */
...
typedef struct _Ifx_XBAR_PRIOH_Bits
{
    ...
    unsigned int MASTER10:3;                /**< \brief [10:8] Master 10 Priority (rw) */
    unsigned int reserved_11:1;             /**< \brief \internal Reserved */
    unsigned int MASTER11:3;                /**< \brief [14:12] Master 11 Priority (rw) */
...
typedef struct _Ifx_XBAR_PRIOL_Bits
{
    ...
    unsigned int reserved_23:1;             /**< \brief \internal Reserved */
    unsigned int MASTER6:3;                 /**< \brief [26:24] Master 6 Priority (rw) */
...
typedef volatile struct _Ifx_XBAR_ARBITER2
{
    ...
    Ifx_XBAR_ERR ERR;                       /**< \brief 10, Error/Debug Capture Register */
    Ifx_XBAR_DBCON DBCON;                   /**< \brief 14, Debug Control Register */
    Ifx_XBAR_ARBITER2_DBADD DBADD;          /**< \brief 18, Debug Address Register */
    Ifx_XBAR_ARBITER2_DBMADD DBMADD;        /**< \brief 1C, Debug Mask Address Register */
} Ifx_XBAR_ARBITER2;
...
typedef volatile struct _Ifx_XBAR
{
    ...
    unsigned char reserved_A4[32];          /**< \brief A4, \internal Reserved */
    Ifx_XBAR_ARBITER2 ARBITER2;             /**< \brief C4, Arbiter objects */
    unsigned char reserved_E4[96];          /**< \brief E4, \internal Reserved */
