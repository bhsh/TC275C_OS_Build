...
typedef volatile struct _Ifx_PSI5
{
    ...
    Ifx_PSI5_CH CH[3];                      /**< \brief 30, Protection range */
    unsigned char reserved_1E0[280];        /**< \brief 1E0, \internal Reserved */
    Ifx_PSI5_INTOV INTOV;                   /**< \brief 2F8, Interrupt Overview Register */
    Ifx_PSI5_INP INP[3];                    /**< \brief 2FC, Interrupt Node Pointer Register */
    unsigned char reserved_308[8];          /**< \brief 308, \internal Reserved */
    Ifx_PSI5_INTSTATA INTSTATA[3];          /**< \brief 310, Interrupt Status Register A */
    unsigned char reserved_31C[8];          /**< \brief 31C, \internal Reserved */
    Ifx_PSI5_INTSTATB INTSTATB[3];          /**< \brief 324, Interrupt Status Register B */
    unsigned char reserved_330[8];          /**< \brief 330, \internal Reserved */
    Ifx_PSI5_INTSETA INTSETA[3];            /**< \brief 338, Interrupt Set Register A */
    unsigned char reserved_344[8];          /**< \brief 344, \internal Reserved */
    Ifx_PSI5_INTSETB INTSETB[3];            /**< \brief 34C, Interrupt Set Register B */
    unsigned char reserved_358[8];          /**< \brief 358, \internal Reserved */
    Ifx_PSI5_INTCLRA INTCLRA[3];            /**< \brief 360, Interrupt Clear Register A */
    unsigned char reserved_36C[8];          /**< \brief 36C, \internal Reserved */
    Ifx_PSI5_INTCLRB INTCLRB[3];            /**< \brief 374, Interrupt Clear Register A */
    unsigned char reserved_380[8];          /**< \brief 380, \internal Reserved */
    Ifx_PSI5_INTENA INTENA[3];              /**< \brief 388, Interrupt Enable Register A */
    unsigned char reserved_394[8];          /**< \brief 394, \internal Reserved */
    Ifx_PSI5_INTENB INTENB[3];              /**< \brief 39C, Interrupt Enable Register B */
    unsigned char reserved_3A8[36];         /**< \brief 3A8, \internal Reserved */
    ...
    Ifx_PSI5_RFC RFC[3];                    /**< \brief 3E4, Receive FIFO Control Register */
    unsigned char reserved_3F0[8];          /**< \brief 3F0, \internal Reserved */
    Ifx_PSI5_RDF RDF[3];                    /**< \brief 3F8, Receive Data FIFO */
    unsigned char reserved_404[8];          /**< \brief 404, \internal Reserved */
    Ifx_PSI5_RSIOV RSIOV[3];                /**< \brief 40C, RSI Overview Register */
    unsigned char reserved_418[8];          /**< \brief 418, \internal Reserved */
    Ifx_PSI5_RMIOV RMIOV[3];                /**< \brief 420, RMI Overview Register */
    unsigned char reserved_42C[8];          /**< \brief 42C, \internal Reserved */
    Ifx_PSI5_NBIOV NBIOV[3];                /**< \brief 434, NBI Overview Register */
    unsigned char reserved_440[8];          /**< \brief 440, \internal Reserved */
    Ifx_PSI5_TEIOV TEIOV[3];                /**< \brief 448, TEI Overview Register */
    unsigned char reserved_454[8];          /**< \brief 454, \internal Reserved */
    Ifx_PSI5_CRCIOV CRCIOV[3];              /**< \brief 45C, CRCI Overview Register */
    unsigned char reserved_468[8];          /**< \brief 468, \internal Reserved */
    Ifx_PSI5_RDIOV RDIOV[3];                /**< \brief 470, RDI Overview Register */
    unsigned char reserved_47C[8];          /**< \brief 47C, \internal Reserved */
    Ifx_PSI5_NFIOV NFIOV[3];                /**< \brief 484, NFI Overview Register */
    unsigned char reserved_490[8];          /**< \brief 490, \internal Reserved */
    Ifx_PSI5_MEIOV MEIOV[3];                /**< \brief 498, MEI Overview Register */
    unsigned char reserved_4A4[8];          /**< \brief 4A4, \internal Reserved */
    Ifx_PSI5_RSISET RSISET[3];              /**< \brief 4AC, RSIOV Set Register */
    unsigned char reserved_4B8[8];          /**< \brief 4B8, \internal Reserved */
    Ifx_PSI5_RMISET RMISET[3];              /**< \brief 4C0, RMIOV Set Register */
    unsigned char reserved_4CC[8];          /**< \brief 4CC, \internal Reserved */
    Ifx_PSI5_NBISET NBISET[3];              /**< \brief 4D4, NBIOV Set Register */
    unsigned char reserved_4E0[8];          /**< \brief 4E0, \internal Reserved */
    Ifx_PSI5_TEISET TEISET[3];              /**< \brief 4E8, TEIOV Set Register */
    unsigned char reserved_4F4[8];          /**< \brief 4F4, \internal Reserved */
    Ifx_PSI5_CRCISET CRCISET[3];            /**< \brief 4FC, CRCIOV Set Register */
    unsigned char reserved_508[8];          /**< \brief 508, \internal Reserved */
    Ifx_PSI5_RDISET RDISET[3];              /**< \brief 510, RDIOV Set Register */
    unsigned char reserved_51C[8];          /**< \brief 51C, \internal Reserved */
    Ifx_PSI5_NFISET NFISET[3];              /**< \brief 524, NFIOV Set Register */
    unsigned char reserved_530[8];          /**< \brief 530, \internal Reserved */
    Ifx_PSI5_MEISET MEISET[3];              /**< \brief 538, MEIOV Set Register */
    unsigned char reserved_544[8];          /**< \brief 544, \internal Reserved */
    Ifx_PSI5_RSICLR RSICLR[3];              /**< \brief 54C, RSIOV Clear Register */
    unsigned char reserved_558[8];          /**< \brief 558, \internal Reserved */
    Ifx_PSI5_RMICLR RMICLR[3];              /**< \brief 560, RMIOV Clear Register */
    unsigned char reserved_56C[8];          /**< \brief 56C, \internal Reserved */
    Ifx_PSI5_NBICLR NBICLR[3];              /**< \brief 574, NBIOV Clear Register */
    unsigned char reserved_580[8];          /**< \brief 580, \internal Reserved */
    Ifx_PSI5_TEICLR TEICLR[3];              /**< \brief 588, TEIOV Clear Register */
    unsigned char reserved_594[8];          /**< \brief 594, \internal Reserved */
    Ifx_PSI5_CRCICLR CRCICLR[3];            /**< \brief 59C, CRCIOV Clear Register */
    unsigned char reserved_5A8[8];          /**< \brief 5A8, \internal Reserved */
    Ifx_PSI5_RDICLR RDICLR[3];              /**< \brief 5B0, RDIOV Clear Register */
    unsigned char reserved_5BC[8];          /**< \brief 5BC, \internal Reserved */
    Ifx_PSI5_NFICLR NFICLR[3];              /**< \brief 5C4, NFIOV Clear Register */
    unsigned char reserved_5D0[8];          /**< \brief 5D0, \internal Reserved */
    Ifx_PSI5_MEICLR MEICLR[3];              /**< \brief 5D8, MEIOV Clear Register */
    unsigned char reserved_5E4[28];         /**< \brief 5E4, \internal Reserved */
    Ifx_PSI5_RDM RDM[3][32];                /**< \brief 600, Receive data memory */
    unsigned char reserved_900[512];        /**< \brief 900, \internal Reserved */
} Ifx_PSI5;
/** \}  */
/******************************************************************************/
/** \}  */
