...
typedef struct _Ifx_SBCU_DBGNTT_Bits
{
    ...
    unsigned int HSMRMI:1;                  /**< \brief [12:12] HSM Register FPI Bus Master Interface Status (rw) */
    unsigned int HSMCMI:1;                  /**< \brief [13:13] HSM Cache FPI Bus Master Interface Status (rw) */
