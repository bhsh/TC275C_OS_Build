...
typedef struct _Ifx_SENT_INTOV_Bits
{
    ...
    unsigned int IPC6:1;                    /**< \brief [6:6] Interrupt Pending on Channel 6 (rh) */
    unsigned int IPC7:1;                    /**< \brief [7:7] Interrupt Pending on Channel 7 (rh) */
    unsigned int IPC8:1;                    /**< \brief [8:8] Interrupt Pending on Channel 8 (rh) */
    unsigned int IPC9:1;                    /**< \brief [9:9] Interrupt Pending on Channel 9 (rh) */
...
typedef volatile struct _Ifx_SENT
{
    ...
    unsigned char reserved_A8[64];          /**< \brief A8, \internal Reserved */
    ...
    unsigned char reserved_380[1792];       /**< \brief 380, \internal Reserved */
    Ifx_SENT_RTS RTS[10];                   /**< \brief A80, Receive Time Stamp Register */
    unsigned char reserved_AA8[88];         /**< \brief AA8, \internal Reserved */
} Ifx_SENT;
/** \}  */
/******************************************************************************/
/** \}  */
