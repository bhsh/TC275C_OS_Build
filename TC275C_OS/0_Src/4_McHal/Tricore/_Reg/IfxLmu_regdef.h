...
/** \\brief  LMU Region Access Enable Register */
...
typedef volatile struct _Ifx_LMU_RGN
{
    ...
    Ifx_LMU_RGN_ACCENA ACCENA;              /**< \brief 8, LMU Region Access Enable Register */
    Ifx_LMU_RGN_ACCENB ACCENB;              /**< \brief C, LMU Region Access Enable Register */
} Ifx_LMU_RGN;
/** \}  */
/******************************************************************************/
/** \}  */
