...
typedef struct _Ifx_SCU_CCUCON0_Bits
{
    ...
    unsigned int ADCCLKSEL:2;               /**< \brief [27:26] ADC Clock Selection (rw) */
...
typedef struct _Ifx_SCU_OVCCON_Bits
{
    ...
    unsigned int CSEL2:1;                   /**< \brief [2:2] CPU Select 2 (w) */
...
typedef struct _Ifx_SCU_OVCENABLE_Bits
{
    ...
    unsigned int OVEN2:1;                   /**< \brief [2:2] Overlay Enable 1 (rw) */
    unsigned int reserved_3:29;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_SCU_PMSWCR0_Bits
{
    ...
    unsigned int PWRWKEN:1;                 /**< \brief [24:24] Wake-up Enable on VEXT Supply ramp-up (rw) */
    unsigned int DCDCSYNC:1;                /**< \brief [25:25] DC-DC Synchronisation Enable (rw) */
    unsigned int BLNKFIL:3;                 /**< \brief [28:26] Blanking Filter delay for VEXT Supply Wake-up (rw) */
...
typedef struct _Ifx_SCU_PMSWSTAT_Bits
{
    ...
    unsigned int PWRWKP:1;                  /**< \brief [8:8] Wake-up event on VEXT Supply ramp-up (rh) */
    ...
    unsigned int reserved_16:4;             /**< \brief \internal Reserved */
    ...
    unsigned int PWRWKEN:1;                 /**< \brief [23:23] Wake-up Enable status on VEXT Supply ramp-up (rh) */
    unsigned int BLNKFIL:3;                 /**< \brief [26:24] Blanking Filter Delay for VEXT Supply Wake-up (rh) */
...
typedef struct _Ifx_SCU_PMSWSTATCLR_Bits
{
    ...
    unsigned int PWRWKPCLR:1;               /**< \brief [8:8] PWRWKP Wake-up indication flag clear (w) */
    unsigned int reserved_9:23;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_SCU_RSTCON2_Bits
{
    ...
    unsigned int CSS2:1;                    /**< \brief [14:14] CPU2 Safe State Reached (rh) */
    unsigned int reserved_15:1;             /**< \brief \internal Reserved */
