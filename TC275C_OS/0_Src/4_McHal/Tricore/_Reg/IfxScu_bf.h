...
/** \\brief  Length for Ifx_SCU_CCUCON0_Bits.ADCCLKSEL */
#define IFX_SCU_CCUCON0_ADCCLKSEL_LEN (2)

/** \\brief  Mask for Ifx_SCU_CCUCON0_Bits.ADCCLKSEL */
#define IFX_SCU_CCUCON0_ADCCLKSEL_MSK (0x3)

/** \\brief  Offset for Ifx_SCU_CCUCON0_Bits.ADCCLKSEL */
#define IFX_SCU_CCUCON0_ADCCLKSEL_OFF (26)

/** \\brief  Length for Ifx_SCU_CCUCON0_Bits.BAUD1DIV */
#define IFX_SCU_CCUCON0_BAUD1DIV_LEN (4)

/** \\brief  Mask for Ifx_SCU_CCUCON0_Bits.BAUD1DIV */
#define IFX_SCU_CCUCON0_BAUD1DIV_MSK (0xf)

/** \\brief  Offset for Ifx_SCU_CCUCON0_Bits.BAUD1DIV */
#define IFX_SCU_CCUCON0_BAUD1DIV_OFF (0)
...
#define IFX_SCU_CCUCON3_SLCK_LEN (1)

/** \\brief  Mask for Ifx_SCU_CCUCON3_Bits.SLCK */
#define IFX_SCU_CCUCON3_SLCK_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_CCUCON3_Bits.SLCK */
#define IFX_SCU_CCUCON3_SLCK_OFF (29)
...
#define IFX_SCU_CCUCON4_SLCK_LEN (1)

/** \\brief  Mask for Ifx_SCU_CCUCON4_Bits.SLCK */
#define IFX_SCU_CCUCON4_SLCK_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_CCUCON4_Bits.SLCK */
#define IFX_SCU_CCUCON4_SLCK_OFF (29)
...
#define IFX_SCU_CCUCON7_CPU1DIV_LEN (6)

/** \\brief  Mask for Ifx_SCU_CCUCON7_Bits.CPU1DIV */
#define IFX_SCU_CCUCON7_CPU1DIV_MSK (0x3f)

/** \\brief  Offset for Ifx_SCU_CCUCON7_Bits.CPU1DIV */
#define IFX_SCU_CCUCON7_CPU1DIV_OFF (0)

/** \\brief  Length for Ifx_SCU_CCUCON8_Bits.CPU2DIV */
#define IFX_SCU_CCUCON8_CPU2DIV_LEN (6)

/** \\brief  Mask for Ifx_SCU_CCUCON8_Bits.CPU2DIV */
#define IFX_SCU_CCUCON8_CPU2DIV_MSK (0x3f)

/** \\brief  Offset for Ifx_SCU_CCUCON8_Bits.CPU2DIV */
#define IFX_SCU_CCUCON8_CPU2DIV_OFF (0)
...
#define IFX_SCU_EVRADCSTAT_ADC33V_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRADCSTAT_Bits.ADC33V */
#define IFX_SCU_EVRADCSTAT_ADC33V_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRADCSTAT_Bits.ADC33V */
#define IFX_SCU_EVRADCSTAT_ADC33V_OFF (8)
...
#define IFX_SCU_EVRMONCTRL_EVR33OVMOD_LEN (2)

/** \\brief  Mask for Ifx_SCU_EVRMONCTRL_Bits.EVR33OVMOD */
#define IFX_SCU_EVRMONCTRL_EVR33OVMOD_MSK (0x3)

/** \\brief  Offset for Ifx_SCU_EVRMONCTRL_Bits.EVR33OVMOD */
#define IFX_SCU_EVRMONCTRL_EVR33OVMOD_OFF (8)

/** \\brief  Length for Ifx_SCU_EVRMONCTRL_Bits.EVR33UVMOD */
#define IFX_SCU_EVRMONCTRL_EVR33UVMOD_LEN (2)

/** \\brief  Mask for Ifx_SCU_EVRMONCTRL_Bits.EVR33UVMOD */
#define IFX_SCU_EVRMONCTRL_EVR33UVMOD_MSK (0x3)

/** \\brief  Offset for Ifx_SCU_EVRMONCTRL_Bits.EVR33UVMOD */
#define IFX_SCU_EVRMONCTRL_EVR33UVMOD_OFF (12)
...
#define IFX_SCU_EVROVMON_EVR33OVVAL_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVROVMON_Bits.EVR33OVVAL */
#define IFX_SCU_EVROVMON_EVR33OVVAL_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVROVMON_Bits.EVR33OVVAL */
#define IFX_SCU_EVROVMON_EVR33OVVAL_OFF (8)
...
#define IFX_SCU_EVRRSTCON_BPRST13OFF_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRRSTCON_Bits.BPRST13OFF */
#define IFX_SCU_EVRRSTCON_BPRST13OFF_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRRSTCON_Bits.BPRST13OFF */
#define IFX_SCU_EVRRSTCON_BPRST13OFF_OFF (25)

/** \\brief  Length for Ifx_SCU_EVRRSTCON_Bits.BPRST33OFF */
#define IFX_SCU_EVRRSTCON_BPRST33OFF_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRRSTCON_Bits.BPRST33OFF */
#define IFX_SCU_EVRRSTCON_BPRST33OFF_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRRSTCON_Bits.BPRST33OFF */
#define IFX_SCU_EVRRSTCON_BPRST33OFF_OFF (27)
...
#define IFX_SCU_EVRSDCOEFF2_SD33D_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCOEFF2_Bits.SD33D */
#define IFX_SCU_EVRSDCOEFF2_SD33D_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRSDCOEFF2_Bits.SD33D */
#define IFX_SCU_EVRSDCOEFF2_SD33D_OFF (16)

/** \\brief  Length for Ifx_SCU_EVRSDCOEFF2_Bits.SD33I */
#define IFX_SCU_EVRSDCOEFF2_SD33I_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCOEFF2_Bits.SD33I */
#define IFX_SCU_EVRSDCOEFF2_SD33I_MSK (0xff)
...
#define IFX_SCU_EVRSDCOEFF2_SD33P_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCOEFF2_Bits.SD33P */
#define IFX_SCU_EVRSDCOEFF2_SD33P_MSK (0xff)
...
#define IFX_SCU_EVRSDCTRL1_SDFREQ_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCTRL1_Bits.SDFREQ */
#define IFX_SCU_EVRSDCTRL1_SDFREQ_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRSDCTRL1_Bits.SDFREQ */
#define IFX_SCU_EVRSDCTRL1_SDFREQ_OFF (16)

/** \\brief  Length for Ifx_SCU_EVRSDCTRL1_Bits.SDFREQSPRD */
#define IFX_SCU_EVRSDCTRL1_SDFREQSPRD_LEN (16)

/** \\brief  Mask for Ifx_SCU_EVRSDCTRL1_Bits.SDFREQSPRD */
#define IFX_SCU_EVRSDCTRL1_SDFREQSPRD_MSK (0xffff)
...
#define IFX_SCU_EVRSDCTRL1_SDSAMPLE_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRSDCTRL1_Bits.SDSAMPLE */
#define IFX_SCU_EVRSDCTRL1_SDSAMPLE_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRSDCTRL1_Bits.SDSAMPLE */
#define IFX_SCU_EVRSDCTRL1_SDSAMPLE_OFF (30)
...
#define IFX_SCU_EVRSDCTRL2_DRVN_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCTRL2_Bits.DRVN */
#define IFX_SCU_EVRSDCTRL2_DRVN_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRSDCTRL2_Bits.DRVN */
#define IFX_SCU_EVRSDCTRL2_DRVN_OFF (16)

/** \\brief  Length for Ifx_SCU_EVRSDCTRL2_Bits.DRVP */
#define IFX_SCU_EVRSDCTRL2_DRVP_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCTRL2_Bits.DRVP */
#define IFX_SCU_EVRSDCTRL2_DRVP_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRSDCTRL2_Bits.DRVP */
#define IFX_SCU_EVRSDCTRL2_DRVP_OFF (0)
...
#define IFX_SCU_EVRSDCTRL2_SDMINMAXDC_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRSDCTRL2_Bits.SDMINMAXDC */
#define IFX_SCU_EVRSDCTRL2_SDMINMAXDC_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRSDCTRL2_Bits.SDMINMAXDC */
#define IFX_SCU_EVRSDCTRL2_SDMINMAXDC_OFF (8)
...
#define IFX_SCU_EVRSTAT_OV33_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRSTAT_Bits.OV33 */
#define IFX_SCU_EVRSTAT_OV33_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRSTAT_Bits.OV33 */
#define IFX_SCU_EVRSTAT_OV33_OFF (3)
...
#define IFX_SCU_EVRSTAT_UV33_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRSTAT_Bits.UV33 */
#define IFX_SCU_EVRSTAT_UV33_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRSTAT_Bits.UV33 */
#define IFX_SCU_EVRSTAT_UV33_OFF (6)
...
#define IFX_SCU_EVRTRIM_EVR13TRIM_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRTRIM_Bits.EVR13TRIM */
#define IFX_SCU_EVRTRIM_EVR13TRIM_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRTRIM_Bits.EVR13TRIM */
#define IFX_SCU_EVRTRIM_EVR13TRIM_OFF (0)

/** \\brief  Length for Ifx_SCU_EVRTRIM_Bits.LCK */
#define IFX_SCU_EVRTRIM_LCK_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRTRIM_Bits.LCK */
#define IFX_SCU_EVRTRIM_LCK_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRTRIM_Bits.LCK */
#define IFX_SCU_EVRTRIM_LCK_OFF (31)

/** \\brief  Length for Ifx_SCU_EVRTRIM_Bits.SDVOUTSEL */
#define IFX_SCU_EVRTRIM_SDVOUTSEL_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRTRIM_Bits.SDVOUTSEL */
#define IFX_SCU_EVRTRIM_SDVOUTSEL_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRTRIM_Bits.SDVOUTSEL */
#define IFX_SCU_EVRTRIM_SDVOUTSEL_OFF (8)

/** \\brief  Length for Ifx_SCU_EVRTRIM_Bits.SLCK */
#define IFX_SCU_EVRTRIM_SLCK_LEN (1)

/** \\brief  Mask for Ifx_SCU_EVRTRIM_Bits.SLCK */
#define IFX_SCU_EVRTRIM_SLCK_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_EVRTRIM_Bits.SLCK */
#define IFX_SCU_EVRTRIM_SLCK_OFF (30)
...
#define IFX_SCU_EVRUVMON_EVR33UVVAL_LEN (8)

/** \\brief  Mask for Ifx_SCU_EVRUVMON_Bits.EVR33UVVAL */
#define IFX_SCU_EVRUVMON_EVR33UVVAL_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_EVRUVMON_Bits.EVR33UVVAL */
#define IFX_SCU_EVRUVMON_EVR33UVVAL_OFF (8)
...
/** \\brief  Length for Ifx_SCU_PMSWCR0_Bits.BLNKFIL */
#define IFX_SCU_PMSWCR0_BLNKFIL_LEN (3)

/** \\brief  Mask for Ifx_SCU_PMSWCR0_Bits.BLNKFIL */
#define IFX_SCU_PMSWCR0_BLNKFIL_MSK (0x7)

/** \\brief  Offset for Ifx_SCU_PMSWCR0_Bits.BLNKFIL */
#define IFX_SCU_PMSWCR0_BLNKFIL_OFF (26)
...
/** \\brief  Length for Ifx_SCU_PMSWCR0_Bits.PWRWKEN */
#define IFX_SCU_PMSWCR0_PWRWKEN_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWCR0_Bits.PWRWKEN */
#define IFX_SCU_PMSWCR0_PWRWKEN_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWCR0_Bits.PWRWKEN */
#define IFX_SCU_PMSWCR0_PWRWKEN_OFF (24)
...
/** \\brief  Length for Ifx_SCU_PMSWSTAT_Bits.BLNKFIL */
#define IFX_SCU_PMSWSTAT_BLNKFIL_LEN (3)

/** \\brief  Mask for Ifx_SCU_PMSWSTAT_Bits.BLNKFIL */
#define IFX_SCU_PMSWSTAT_BLNKFIL_MSK (0x7)

/** \\brief  Offset for Ifx_SCU_PMSWSTAT_Bits.BLNKFIL */
#define IFX_SCU_PMSWSTAT_BLNKFIL_OFF (24)
...
/** \\brief  Length for Ifx_SCU_PMSWSTAT_Bits.PWRWKEN */
#define IFX_SCU_PMSWSTAT_PWRWKEN_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWSTAT_Bits.PWRWKEN */
#define IFX_SCU_PMSWSTAT_PWRWKEN_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWSTAT_Bits.PWRWKEN */
#define IFX_SCU_PMSWSTAT_PWRWKEN_OFF (23)

/** \\brief  Length for Ifx_SCU_PMSWSTAT_Bits.PWRWKP */
#define IFX_SCU_PMSWSTAT_PWRWKP_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWSTAT_Bits.PWRWKP */
#define IFX_SCU_PMSWSTAT_PWRWKP_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWSTAT_Bits.PWRWKP */
#define IFX_SCU_PMSWSTAT_PWRWKP_OFF (8)
...
#define IFX_SCU_PMSWSTAT_TRIST_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWSTAT_Bits.TRIST */
#define IFX_SCU_PMSWSTAT_TRIST_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWSTAT_Bits.TRIST */
#define IFX_SCU_PMSWSTAT_TRIST_OFF (15)
...
/** \\brief  Length for Ifx_SCU_PMSWSTATCLR_Bits.PWRWKPCLR */
#define IFX_SCU_PMSWSTATCLR_PWRWKPCLR_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWSTATCLR_Bits.PWRWKPCLR */
#define IFX_SCU_PMSWSTATCLR_PWRWKPCLR_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWSTATCLR_Bits.PWRWKPCLR */
#define IFX_SCU_PMSWSTATCLR_PWRWKPCLR_OFF (8)
