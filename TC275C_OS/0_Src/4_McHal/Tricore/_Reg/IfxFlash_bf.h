...
/** \\brief  Length for Ifx_FLASH_FSR_Bits.D1BUSY */
#define IFX_FLASH_FSR_D1BUSY_LEN (1)

/** \\brief  Mask for Ifx_FLASH_FSR_Bits.D1BUSY */
#define IFX_FLASH_FSR_D1BUSY_MSK (0x1)

/** \\brief  Offset for Ifx_FLASH_FSR_Bits.D1BUSY */
#define IFX_FLASH_FSR_D1BUSY_OFF (2)
...
#define IFX_FLASH_FSR_P1BUSY_LEN (1)

/** \\brief  Mask for Ifx_FLASH_FSR_Bits.P1BUSY */
#define IFX_FLASH_FSR_P1BUSY_MSK (0x1)

/** \\brief  Offset for Ifx_FLASH_FSR_Bits.P1BUSY */
#define IFX_FLASH_FSR_P1BUSY_OFF (4)
...
/** \\brief  Length for Ifx_FLASH_ID_Bits.MOD_REV */
#define IFX_FLASH_ID_MOD_REV_LEN (8)

/** \\brief  Mask for Ifx_FLASH_ID_Bits.MOD_REV */
#define IFX_FLASH_ID_MOD_REV_MSK (0xff)

/** \\brief  Offset for Ifx_FLASH_ID_Bits.MOD_REV */
#define IFX_FLASH_ID_MOD_REV_OFF (0)

/** \\brief  Length for Ifx_FLASH_ID_Bits.MOD_TYPE */
#define IFX_FLASH_ID_MOD_TYPE_LEN (8)

/** \\brief  Mask for Ifx_FLASH_ID_Bits.MOD_TYPE */
#define IFX_FLASH_ID_MOD_TYPE_MSK (0xff)

/** \\brief  Offset for Ifx_FLASH_ID_Bits.MOD_TYPE */
#define IFX_FLASH_ID_MOD_TYPE_OFF (8)
...
#define IFX_FLASH_MARP_SELP1_LEN (1)

/** \\brief  Mask for Ifx_FLASH_MARP_Bits.SELP1 */
#define IFX_FLASH_MARP_SELP1_MSK (0x1)

/** \\brief  Offset for Ifx_FLASH_MARP_Bits.SELP1 */
#define IFX_FLASH_MARP_SELP1_OFF (1)
...
#define IFX_FLASH_PROCOND_MODE_LEN (2)

/** \\brief  Mask for Ifx_FLASH_PROCOND_Bits.MODE */
#define IFX_FLASH_PROCOND_MODE_MSK (0x3)

/** \\brief  Offset for Ifx_FLASH_PROCOND_Bits.MODE */
#define IFX_FLASH_PROCOND_MODE_OFF (9)
...
#define IFX_FLASH_PROCOND_OSCCFG_LEN (1)

/** \\brief  Mask for Ifx_FLASH_PROCOND_Bits.OSCCFG */
#define IFX_FLASH_PROCOND_OSCCFG_MSK (0x1)

/** \\brief  Offset for Ifx_FLASH_PROCOND_Bits.OSCCFG */
#define IFX_FLASH_PROCOND_OSCCFG_OFF (8)
