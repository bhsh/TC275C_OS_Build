...
#define IFX_MC_CONFIG1_SELFASTB_LEN (4)

/** \\brief  Mask for Ifx_MC_CONFIG1_Bits.SELFASTB */
#define IFX_MC_CONFIG1_SELFASTB_MSK (0xf)

/** \\brief  Offset for Ifx_MC_CONFIG1_Bits.SELFASTB */
#define IFX_MC_CONFIG1_SELFASTB_OFF (8)

/** \\brief  Length for Ifx_MC_ECCD_Bits.AENE */
#define IFX_MC_ECCD_AENE_LEN (1)

/** \\brief  Mask for Ifx_MC_ECCD_Bits.AENE */
#define IFX_MC_ECCD_AENE_MSK (0x1)

/** \\brief  Offset for Ifx_MC_ECCD_Bits.AENE */
#define IFX_MC_ECCD_AENE_OFF (13)
...
#define IFX_MC_ECCD_CENE_LEN (1)

/** \\brief  Mask for Ifx_MC_ECCD_Bits.CENE */
#define IFX_MC_ECCD_CENE_MSK (0x1)

/** \\brief  Offset for Ifx_MC_ECCD_Bits.CENE */
#define IFX_MC_ECCD_CENE_OFF (11)
...
#define IFX_MC_ECCD_ECE_LEN (1)

/** \\brief  Mask for Ifx_MC_ECCD_Bits.ECE */
#define IFX_MC_ECCD_ECE_MSK (0x1)

/** \\brief  Offset for Ifx_MC_ECCD_Bits.ECE */
#define IFX_MC_ECCD_ECE_OFF (14)
...
#define IFX_MC_ECCD_RARVAL_LEN (1)

/** \\brief  Mask for Ifx_MC_ECCD_Bits.RARVAL */
#define IFX_MC_ECCD_RARVAL_MSK (0x1)

/** \\brief  Offset for Ifx_MC_ECCD_Bits.RARVAL */
#define IFX_MC_ECCD_RARVAL_OFF (10)
...
#define IFX_MC_ECCD_UENE_LEN (1)

/** \\brief  Mask for Ifx_MC_ECCD_Bits.UENE */
#define IFX_MC_ECCD_UENE_MSK (0x1)

/** \\brief  Offset for Ifx_MC_ECCD_Bits.UENE */
#define IFX_MC_ECCD_UENE_OFF (12)
...
#define IFX_MC_ECCD_VAL_LEN (5)

/** \\brief  Mask for Ifx_MC_ECCD_Bits.VAL */
#define IFX_MC_ECCD_VAL_MSK (0x1f)
...
#define IFX_MC_MCONTROL_RESUME_OFF (1)
...
#define IFX_MC_MSTATUS_FDA_OFF (2)

/** \\brief  Length for Ifx_MC_MSTATUS_Bits.SFAIL */
#define IFX_MC_MSTATUS_SFAIL_LEN (1)

/** \\brief  Mask for Ifx_MC_MSTATUS_Bits.SFAIL */
#define IFX_MC_MSTATUS_SFAIL_MSK (0x1)

/** \\brief  Offset for Ifx_MC_MSTATUS_Bits.SFAIL */
#define IFX_MC_MSTATUS_SFAIL_OFF (3)
