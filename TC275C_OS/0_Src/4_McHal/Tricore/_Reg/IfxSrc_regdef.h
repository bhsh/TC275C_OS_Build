...
{
    Ifx_SRC_SRCR SR[6];                     /**< \brief 0, DAM Service Request */
} Ifx_SRC_DAM;
...
typedef volatile struct _Ifx_SRC_DMA
{
    ...
    Ifx_SRC_SRCR CH[64];                    /**< \brief 10, DMA Channel Service Request */
} Ifx_SRC_DMA;
...
typedef volatile struct _Ifx_SRC_GTM
{
    ...
    unsigned char reserved_200[384];        /**< \brief 200, \internal Reserved */
    Ifx_SRC_SRCR MCS[4][8];                 /**< \brief 380, GTM MCS Shared Service Request */
    unsigned char reserved_400[384];        /**< \brief 400, \internal Reserved */
    Ifx_SRC_SRCR TOM[3][8];                 /**< \brief 580, GTM TOM Shared Service Request */
    unsigned char reserved_5E0[416];        /**< \brief 5E0, \internal Reserved */
    Ifx_SRC_SRCR ATOM[5][4];                /**< \brief 780, GTM ATOM Shared Service Request */
    unsigned char reserved_7D0[304];        /**< \brief 7D0, \internal Reserved */
    Ifx_SRC_SRCR MCSW0[4];                  /**< \brief 900, GTM Multi Channel Sequencer 0 Service Request */
    unsigned char reserved_910[48];         /**< \brief 910, \internal Reserved */
    Ifx_SRC_SRCR MCSW1[4];                  /**< \brief 940, GTM Multi Channel Sequencer 1 Service Request */
} Ifx_SRC_GTM;
...
{
    Ifx_SRC_SRCR SR[10];                    /**< \brief 0, SENT TRIG Service Request */
} Ifx_SRC_SENT;
...
{
    Ifx_SRC_CPU CPU[3];                     /**< \brief 0, CPU Service requests */
} Ifx_SRC_GCPU;

/** \\brief  DAM Service requests */
typedef volatile struct _Ifx_SRC_GDAM
{
    Ifx_SRC_DAM DAM[1];                     /**< \brief 0, DAM Service requests */
} Ifx_SRC_GDAM;
...
{
    Ifx_SRC_DSADC DSADC[6];                 /**< \brief 0, DSADC Service requests */
} Ifx_SRC_GDSADC;
...
{
    Ifx_SRC_GPSR GPSR[3];                   /**< \brief 0, GPSR Service requests */
} Ifx_SRC_GGPSR;
...
{
    Ifx_SRC_STM STM[3];                     /**< \brief 0, STM Service requests */
} Ifx_SRC_GSTM;

/** \\brief  VADC Service requests */
typedef volatile struct _Ifx_SRC_GVADC
{
    Ifx_SRC_VADCG G[8];                     /**< \brief 0, VADCG Service requests */
    unsigned char reserved_80[160];         /**< \brief 80, \internal Reserved */
...
typedef volatile struct _Ifx_SRC
{
    ...
    unsigned char reserved_378[104];        /**< \brief 378, \internal Reserved */
    ...
    unsigned char reserved_4A8[8];          /**< \brief 4A8, \internal Reserved */
    ...
    unsigned char reserved_600[752];        /**< \brief 600, \internal Reserved */
    ...
    unsigned char reserved_B80[96];         /**< \brief B80, \internal Reserved */
    ...
    unsigned char reserved_D50[32];         /**< \brief D50, \internal Reserved */
    Ifx_SRC_GDAM DAM;                       /**< \brief D70, DAM Service requests */
    unsigned char reserved_D88[24];         /**< \brief D88, \internal Reserved */
    ...
    unsigned char reserved_E10[496];        /**< \brief E10, \internal Reserved */
    Ifx_SRC_GGPSR GPSR;                     /**< \brief 1000, GPSR Service requests */
    unsigned char reserved_1060[1440];      /**< \brief 1060, \internal Reserved */
    Ifx_SRC_GGTM GTM;                       /**< \brief 1600, GTM Service requests */
    unsigned char reserved_1F50[176];       /**< \brief 1F50, \internal Reserved */
} Ifx_SRC;
/** \}  */
/******************************************************************************/
/** \}  */
