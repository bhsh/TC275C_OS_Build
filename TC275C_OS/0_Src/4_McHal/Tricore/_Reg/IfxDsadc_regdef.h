...
{
    unsigned int RG00:1;                    /**< \brief [0:0] Register Group 0, Channels 0 - 3 (rw) */
    unsigned int RG01:1;                    /**< \brief [1:1] Register Group 1, Channels 0 - 3 (rw) */
    unsigned int RG02:1;                    /**< \brief [2:2] Register Group 2, Channels 0 - 3 (rw) */
    unsigned int RG03:1;                    /**< \brief [3:3] Register Group 3, Channels 0 - 3 (rw) */
    unsigned int RG04:1;                    /**< \brief [4:4] Register Group 4, Channels 0 - 3 (rw) */
    ...
    unsigned int RG40:1;                    /**< \brief [16:16] Register Group 0, Channels 4 - 5 (rw) */
    unsigned int RG41:1;                    /**< \brief [17:17] Register Group 1, Channels 4 - 5 (rw) */
    unsigned int RG42:1;                    /**< \brief [18:18] Register Group 2, Channels 4 - 5 (rw) */
    unsigned int RG43:1;                    /**< \brief [19:19] Register Group 3, Channels 4 - 5 (rw) */
    unsigned int RG44:1;                    /**< \brief [20:20] Register Group 4, Channels 4 - 5 (rw) */
...
typedef struct _Ifx_DSADC_EVFLAGCLR_Bits
{
    ...
    unsigned int RESEC1:1;                  /**< \brief [1:1] Result Event Clear (w) */
    unsigned int RESEC2:1;                  /**< \brief [2:2] Result Event Clear (w) */
    unsigned int RESEC3:1;                  /**< \brief [3:3] Result Event Clear (w) */
    unsigned int RESEC4:1;                  /**< \brief [4:4] Result Event Clear (w) */
    unsigned int RESEC5:1;                  /**< \brief [5:5] Result Event Clear (w) */
    unsigned int reserved_6:10;             /**< \brief \internal Reserved */
    unsigned int ALEC0:1;                   /**< \brief [16:16] Alarm Event Clear (w) */
    unsigned int ALEC1:1;                   /**< \brief [17:17] Alarm Event Clear (w) */
    unsigned int ALEC2:1;                   /**< \brief [18:18] Alarm Event Clear (w) */
    unsigned int ALEC3:1;                   /**< \brief [19:19] Alarm Event Clear (w) */
    unsigned int ALEC4:1;                   /**< \brief [20:20] Alarm Event Clear (w) */
    unsigned int ALEC5:1;                   /**< \brief [21:21] Alarm Event Clear (w) */
    unsigned int reserved_22:10;            /**< \brief \internal Reserved */
...
typedef struct _Ifx_DSADC_GLOBCFG_Bits
{
    ...
    unsigned int IRM2:1;                    /**< \brief [12:12] Internal Resistance Measurement Control (rw) */
    unsigned int IRM4:1;                    /**< \brief [13:13] Internal Resistance Measurement Control (rw) */
...
typedef struct _Ifx_DSADC_GLOBRC_Bits
{
    ...
    unsigned int CH1RUN:1;                  /**< \brief [1:1] Channel 1 Run Control (rw) */
    unsigned int CH2RUN:1;                  /**< \brief [2:2] Channel 2 Run Control (rw) */
    unsigned int CH3RUN:1;                  /**< \brief [3:3] Channel 3 Run Control (rw) */
    unsigned int CH4RUN:1;                  /**< \brief [4:4] Channel 4 Run Control (rw) */
    unsigned int CH5RUN:1;                  /**< \brief [5:5] Channel 5 Run Control (rw) */
    unsigned int reserved_6:10;             /**< \brief \internal Reserved */
    unsigned int M0RUN:1;                   /**< \brief [16:16] Modulator 0 Run Control (rw) */
    unsigned int M1RUN:1;                   /**< \brief [17:17] Modulator 1 Run Control (rw) */
    unsigned int M2RUN:1;                   /**< \brief [18:18] Modulator 2 Run Control (rw) */
    unsigned int M3RUN:1;                   /**< \brief [19:19] Modulator 3 Run Control (rw) */
    unsigned int M4RUN:1;                   /**< \brief [20:20] Modulator 4 Run Control (rw) */
    unsigned int M5RUN:1;                   /**< \brief [21:21] Modulator 5 Run Control (rw) */
    unsigned int reserved_22:10;            /**< \brief \internal Reserved */
...
{
    unsigned int IN0PVC0:1;                 /**< \brief [0:0] Voltage Control of Positive Input 0 of CH0 (rw) */
    unsigned int reserved_1:3;              /**< \brief \internal Reserved */
    unsigned int IN0NVC0:1;                 /**< \brief [4:4] Voltage Control of Negative Input 0 of CH0 (rw) */
    unsigned int reserved_5:3;              /**< \brief \internal Reserved */
    unsigned int IN1PVC0:1;                 /**< \brief [8:8] Voltage Control of Positive Input 0 of CH1 (rw) */
    unsigned int reserved_9:3;              /**< \brief \internal Reserved */
    unsigned int IN1NVC0:1;                 /**< \brief [12:12] Voltage Control of Negative Input 0 of CH1 (rw) */
    unsigned int reserved_13:3;             /**< \brief \internal Reserved */
    unsigned int IN2PVC0:1;                 /**< \brief [16:16] Voltage Control of Positive Inputs 0-1 of CH2 (rw) */
    unsigned int IN2PVC1:1;                 /**< \brief [17:17] Voltage Control of Positive Inputs 0-1 of CH2 (rw) */
    unsigned int reserved_18:2;             /**< \brief \internal Reserved */
    unsigned int IN2NVC0:1;                 /**< \brief [20:20] Voltage Control of Negative Inputs 0-1 of CH2 (rw) */
    unsigned int IN2NVC1:1;                 /**< \brief [21:21] Voltage Control of Negative Inputs 0-1 of CH2 (rw) */
...
/** \\brief  Common Mode Hold Voltage Register 1 */
typedef struct _Ifx_DSADC_GLOBVCMH1_Bits
{
    unsigned int IN4PVC0:1;                 /**< \brief [0:0] Voltage Control of Positive Input 0 of CH4 (rw) */
    unsigned int reserved_1:3;              /**< \brief \internal Reserved */
    unsigned int IN4NVC0:1;                 /**< \brief [4:4] Voltage Control of Negative Input 0 of CH4 (rw) */
    unsigned int reserved_5:3;              /**< \brief \internal Reserved */
    unsigned int IN5PVC0:1;                 /**< \brief [8:8] Voltage Control of Positive Input 0 of CH5 (rw) */
    unsigned int reserved_9:3;              /**< \brief \internal Reserved */
    unsigned int IN5NVC0:1;                 /**< \brief [12:12] Voltage Control of Negative Input 0 of CH5 (rw) */
...
typedef volatile struct _Ifx_DSADC_CH
{
    ...
    unsigned char reserved_AC[84];          /**< \brief AC, \internal Reserved */
} Ifx_DSADC_CH;
/** \}  */
/******************************************************************************/
/** \}  */
...
typedef volatile struct _Ifx_DSADC
{
    ...
    Ifx_DSADC_GLOBVCMH1 GLOBVCMH1;          /**< \brief B4, Common Mode Hold Voltage Register 1 */
    ...
    Ifx_DSADC_CH CH[6];                     /**< \brief 100, Channel objects */
