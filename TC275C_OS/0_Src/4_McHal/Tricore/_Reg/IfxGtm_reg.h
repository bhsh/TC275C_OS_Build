...
/** \\brief  28484, DPLL Weighted difference of Prediction up to the Last
 * TRIGGER Increment */
#define GTM_DPLL_MEDT_T /*lint --e(923)*/ (*(volatile Ifx_GTM_DPLL_MEDT_T*)0xF0128484u)

/** \\brief  285C0, DPLL Calculated Number of Sub-Pulses between Two STATE
 * Events */
#define GTM_DPLL_MLS1 /*lint --e(923)*/ (*(volatile Ifx_GTM_DPLL_MLS1*)0xF01285C0u)

/** \\brief  285C4, DPLL Calculated Number of Sub-Pulses between Two STATE
 * Events */
