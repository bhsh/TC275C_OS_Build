 ...
 * \ingroup IfxLld_Scu
 * \defgroup IfxLld_Scu_Std_Wdt_Configuration Watchdog Configuration functions
 * \ingroup IfxLld_Scu_Std
 * \defgroup IfxLld_Scu_Std_Wdt_Endinit Watchdog Endinit functions
 * \ingroup IfxLld_Scu_Std
 * \defgroup IfxLld_Scu_Std_Wdt_Operative Watchdog Operative functions
 * \ingroup IfxLld_Scu_Std
 * \defgroup IfxLld_Scu_Std_Wdt_Endinit_Usage How to use Endinit APIs?
 * \ingroup IfxLld_Scu_Std
 */
...
/** \addtogroup IfxLld_Scu_Std_Wdt_Configuration
 * \{ */
...
/** \addtogroup IfxLld_Scu_Std_Wdt_Endinit
 * \{ */
