...
void IfxDsadc_Dsadc_initCarrierGen(IfxDsadc_Dsadc *dsadc, IfxDsadc_Dsadc_CarrierGenConfig *config)
{
...
void IfxDsadc_Dsadc_initChannel(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_ChannelConfig *config)
{
    ...
    if (pins != NULL_PTR)
    {
        ...
        if (dsn != NULL_PTR)
        {
            IfxDsadc_initDsnPin(dsn, pins->dsnMode);
        }
        ...
        if (dsp != NULL_PTR)
        {
            IfxDsadc_initDspPin(dsp, pins->dspMode);
        }
        ...
        if (cin != NULL_PTR)
        {
            IfxDsadc_initCinPin(cin, pins->cinMode);
        }
        ...
        if (din != NULL_PTR)
        {
            IfxDsadc_initDinPin(din, pins->dinMode);
        }
        ...
        if (itr != NULL_PTR)
        {
            IfxDsadc_initItrPin(itr, pins->itrMode);
        }
    }
}
...
void IfxDsadc_Dsadc_initModule(IfxDsadc_Dsadc *dsadc, IfxDsadc_Dsadc_Config *config)
{
