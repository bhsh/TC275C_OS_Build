 ...
 * The configuration includes input/output, mode, pad driver strength and state. For referencing the pins and their ports a \ref IfxPort_PinMap is available as well.
 *
 ...
 * \endcode
 *
 * Note: the IfxPort_* pins are defined in \ref IfxPort_PinMap
 *
