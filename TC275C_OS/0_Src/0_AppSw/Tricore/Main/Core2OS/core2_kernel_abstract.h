...
/****************************************************************************/
  ...
  #define CORE2_PTHREAD_INITIALIZATION_BLOCK  \
            ...
            for (;;){ \
  	        core2_pthread_management_prolog(&pthread_config); 
  	
  #define CORE2_PTHREAD_TASKCALLBACK_BLOCK \
  	      task(&pthread_config);   
  
  #define CORE2_PTHREAD_TERMINATION_BLOCK  \
  	      core2_pthread_management_epilog(&pthread_config);}
  ...
  /****************************************************************************/
  #define CORE2_PTHREAD_INITIALIZATION_BLOCK  \
  	        pthread_config_t pthread_config = core2_pthread_init_config_database[(int)arg];
  ...
  #define core2_thread_termination_event() \
            if(pthread_config.curr_task_type == EVENT) \
  	  	    { __asm( " mov.aa a4,%0 \t\n jg core2_pthread_cond_wait \n" ::"a"(&core2_pthread_cond[pthread_config.curr_task_id]),"a"(core2_pthread_cond_wait):"a4");} \
