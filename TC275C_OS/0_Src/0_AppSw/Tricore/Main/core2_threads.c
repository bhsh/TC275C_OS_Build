...
PTHREAD_CONTROL_BLOCK(core2_th1, CORE2_THREAD1_PRIORITY,SCHED_FIFO,CORE2_THREAD1_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th2, CORE2_THREAD2_PRIORITY,SCHED_FIFO,CORE2_THREAD2_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th3, CORE2_THREAD3_PRIORITY,SCHED_FIFO,CORE2_THREAD3_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th4, CORE2_THREAD4_PRIORITY,SCHED_FIFO,CORE2_THREAD4_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th5, CORE2_THREAD5_PRIORITY,SCHED_FIFO,CORE2_THREAD5_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th6, CORE2_THREAD6_PRIORITY,SCHED_FIFO,CORE2_THREAD6_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th7, CORE2_THREAD7_PRIORITY,SCHED_FIFO,CORE2_THREAD7_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th8, CORE2_THREAD8_PRIORITY,SCHED_FIFO,CORE2_THREAD8_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th9, CORE2_THREAD9_PRIORITY,SCHED_FIFO,CORE2_THREAD9_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core2_th10,CORE2_THREAD10_PRIORITY,SCHED_FIFO,CORE2_THREAD10_STACK_SIZE)
