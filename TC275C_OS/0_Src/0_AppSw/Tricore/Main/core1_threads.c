...
PTHREAD_CONTROL_BLOCK(core1_th0, CORE1_THREAD0_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th1, CORE1_THREAD1_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th2, CORE1_THREAD2_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th3, CORE1_THREAD3_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th4, CORE1_THREAD4_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th5, CORE1_THREAD5_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th6, CORE1_THREAD6_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th7, CORE1_THREAD7_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th8, CORE1_THREAD8_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th9, CORE1_THREAD9_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core1_th10,CORE1_THREAD10_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
