...
#define CORE2_PTHREAD_INITIALIZATION_BLOCK  \
    ...
    for (;;){ \
	  core2_pthread_done_before_task(&pthread_config); 
	
#define CORE2_PTHREAD_TASKCALLBACK_BLOCK \
	  task(&pthread_config);   

#define CORE2_PTHREAD_TERMINATION_BLOCK  \
	  core2_pthread_done_after_task(&pthread_config);}
...
#define CORE2_PTHREAD_CONTROL_BLOCK(thread_id) \
	_CORE2_PTHREAD_CONTROL_BLOCK(core2_os_th##thread_id, \
	                             CORE2_THREAD##thread_id##_PRIORITY, \
	                             SCHED_FIFO, \
	                             CORE2_THREAD##thread_id##_STACK_SIZE)

#define _CORE2_PTHREAD_CREATION_BLOCK(thread_var,thread_attr,thread_name,thread_id,callback_task_name)  \
...
#define CORE2_PTHREAD_CREATION_BLOCK(thread_id) \
	_CORE2_PTHREAD_CREATION_BLOCK(core2_os_th##thread_id, \
