...
#define	 CORE1_TASK2_SWITCH 	ON
#define	 CORE1_TASK3_SWITCH	    ON
#define	 CORE1_TASK4_SWITCH	    ON
#define	 CORE1_TASK5_SWITCH	    ON
#define	 CORE1_TASK6_SWITCH	    ON
#define	 CORE1_TASK7_SWITCH	    ON
#define	 CORE1_TASK8_SWITCH	    ON
#define	 CORE1_TASK9_SWITCH	    ON
#define	 CORE1_TASK10_SWITCH	ON
...
#if (CORE1_TASK0_SWITCH != ON)
  #error "<CORE1> The TASK0 must be on, or there will a compiler error."
#endif
