...
void App_stack_background_count(void)
{
...
void App_stack_calculated(void)
{
...
void App_task_test_count(unsigned int channel)
{
  core0_thread_test_count[channel]++;
}
void  App_flash_led_1(void)
{
   osPort_togglePin(LED_1);
}

void  App_flash_led_2(void)
{
   osPort_togglePin(LED_2);
}

void  App_flash_led_3(void)
{
   osPort_togglePin(LED_3);
}

void  App_flash_led_4(void)
{
