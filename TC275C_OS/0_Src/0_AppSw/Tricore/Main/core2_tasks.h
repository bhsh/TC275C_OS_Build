...
void CORE2_TASK4(pthread_config_t *pthread_config,osu32_t current_core_id);
void CORE2_TASK5(pthread_config_t *pthread_config,osu32_t current_core_id);
void CORE2_TASK6(pthread_config_t *pthread_config,osu32_t current_core_id);
void CORE2_TASK7(pthread_config_t *pthread_config,osu32_t current_core_id);
