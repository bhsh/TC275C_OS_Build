...
void start_core0_os(void) {
    ...
    pthread_create_np(core0_os_th0, &os_thread_attr[CORE_ID0][THREAD_ID0], core0_os_thread0, (void*) 0,CORE0_TASK0);
    pthread_create_np(core0_os_th1, &os_thread_attr[CORE_ID0][THREAD_ID1], core0_os_thread1, (void*) 1,CORE0_TASK1);	
    pthread_create_np(core0_os_th2, &os_thread_attr[CORE_ID0][THREAD_ID2], core0_os_thread2, (void*) 2,CORE0_TASK2);
#if 0	

	pthread_create_np(core0_os_th3, &os_thread_attr[CORE_ID0][THREAD_ID3], core0_os_thread3, (void*) 3,CORE0_TASK3);

	pthread_create_np(core0_os_th4, &os_thread_attr[CORE_ID0][THREAD_ID4], core0_os_thread4, (void*) 4,CORE0_TASK4);
	pthread_create_np(core0_os_th5, &os_thread_attr[CORE_ID0][THREAD_ID5], core0_os_thread5, (void*) 5,CORE0_TASK5);

	pthread_create_np(core0_os_th6, &os_thread_attr[CORE_ID0][THREAD_ID6], core0_os_thread6, (void*) 6,CORE0_TASK6);
	pthread_create_np(core0_os_th7, &os_thread_attr[CORE_ID0][THREAD_ID7], core0_os_thread7, (void*) 7,CORE0_TASK7);
    pthread_create_np(core0_os_th8, &os_thread_attr[CORE_ID0][THREAD_ID8], core0_os_thread8, (void*) 8,CORE0_TASK8);
    pthread_create_np(core0_os_th9, &os_thread_attr[CORE_ID0][THREAD_ID9], core0_os_thread9, (void*) 9,CORE0_TASK9);

#endif
	pthread_create_np(core0_os_th10, &os_thread_attr[CORE_ID0][THREAD_ID10], core0_os_thread10,(void*) 10,CORE0_TASK10);
