...
// period threads...
PTHREAD_CONTROL_BLOCK(core0_os_th0,CORE0_THREAD0_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th1, CORE0_THREAD1_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th2, CORE0_THREAD2_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th3, CORE0_THREAD3_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th4, CORE0_THREAD4_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th5, CORE0_THREAD5_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th6, CORE0_THREAD6_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th7, CORE0_THREAD7_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th8, CORE0_THREAD8_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th9, CORE0_THREAD9_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
PTHREAD_CONTROL_BLOCK(core0_os_th10,CORE0_THREAD10_PRIORITY,SCHED_FIFO,PTHREAD_DEFAULT_STACK_SIZE)
