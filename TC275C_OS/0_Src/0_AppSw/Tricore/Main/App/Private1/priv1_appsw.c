...
/* Macro Definitions                                                        */
/****************************************************************************/
#define  CORE1_TASK_NUM                (11)
#define  CORE1_TOTAL_COUNT             (500000000)
#define  CORE1_TIME_PER_COUNT_NS       (60)
...
typedef enum  {
	 ...
	 FINISH,
	 RUNNING	
}APP_PRIV1_CPU_LOAD_LOGIC_STATUS_t;
...
static volatile unsigned int App_priv1_var_test_count;
  ...
  static volatile unsigned int App_priv1_var_one_stack_used_in_per;
#endif

static volatile unsigned int App_priv1_var_task_test_count[CORE1_TASK_NUM];
...
static volatile unsigned int App_priv1_var_task_test_count0;
static volatile unsigned int App_priv1_var_task_test_count1;
static volatile unsigned int App_priv1_var_task_test_count2;
static volatile unsigned int App_priv1_var_task_test_count3;
static volatile unsigned int App_priv1_var_task_test_count4;
static volatile unsigned int App_priv1_var_task_test_count5;
static volatile unsigned int App_priv1_var_task_test_count6;
static volatile unsigned int App_priv1_var_task_test_count7;
static volatile unsigned int App_priv1_var_task_test_count8;
static volatile unsigned int App_priv1_var_task_test_count9;
static volatile unsigned int App_priv1_var_task_test_count10;
...
/****************************************************************************/
/* FUNCTION NAME: App_priv1_func_test_count                                 */
...
/****************************************************************************/
void App_priv1_func_many_stacks_measured(void)
{
#if (OS_STACK_MODE == MANY_STACKS)
  core1_get_all_stacks_used();
#endif
} /* End of function App_priv1_func_many_stacks_measured */

/****************************************************************************/
/* FUNCTION NAME: App_priv1_func_one_stack_measured                         */
/* DESCRIPTION: Measure the stack usage of many stacks mode                 */
/****************************************************************************/
void App_priv1_func_one_stack_measured(void)
{
#if (OS_STACK_MODE == ONE_STACK)
  App_priv1_var_one_stack_used_in_per = core1_get_the_one_stack_used();
#endif
...
void App_priv1_func_task_test_count(unsigned int channel)
{
  ...
  {
   case 0:
     App_priv1_var_task_test_count0++;
	 break;
   case 1:
     App_priv1_var_task_test_count1++;
	 break;
   case 2:
     App_priv1_var_task_test_count2++;
	 break;
   case 3:
     App_priv1_var_task_test_count3++;
	 break;
   case 4:
     App_priv1_var_task_test_count4++;
	 break;
   case 5:
     App_priv1_var_task_test_count5++;
	 break;
   case 6:
     App_priv1_var_task_test_count6++;
	 break;
   case 7:
     App_priv1_var_task_test_count7++;
	 break;
   case 8:
     App_priv1_var_task_test_count8++;
	 break;
   case 9:
     App_priv1_var_task_test_count9++;
	 break;
   case 10:
     App_priv1_var_task_test_count10++;
	 break;
   default:
   	 break;
  }
...
{
  while((App_priv1_var_CPU_Load_Backg_Count < CORE1_TOTAL_COUNT)&&(App_priv1_var_state_machine_state == RUNNING ))
  {
